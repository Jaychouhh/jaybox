...
import com.jaybox.databinding.ActivityMainBinding
import com.jaybox.util.FileUtil
import com.jaybox.util.InjectionUtil
import com.jaybox.util.inflate
import com.jaybox.view.base.PermissionActivity
import com.jaybox.view.setting.SettingActivity
import com.jaybox.view.widget.ProgressDialog
import java.io.File
...
class MainActivity : PermissionActivity() {
                    ...
                    DumpInfo.TIMEOUT -> {
                        ...
                        MaterialDialog(this).show {
                            ...
                            negativeButton(R.string.github) {
                                val intent = Intent(
                                    Intent.ACTION_VIEW,
                                    Uri.parse("https://github.com/CodingGay/JayBox/issues")
                                )
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.main_git -> {
                val intent =
                    Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/CodingGay/JayBox"))
                startActivity(intent)
            }
